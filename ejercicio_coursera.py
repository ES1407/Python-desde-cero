...
def calculate_subtotal(order):
    ...
    suma = 0
    for comida in order:
        precio_comida = comida['price']
        suma = suma + precio_comida
...
def summarize_order(order):
    ...
    """
    ### WRITE SOLUTION HERE
    subtotal_notax = calculate_subtotal(order) 
    tax = calculate_tax(subtotal_notax)
    total = round(subtotal_notax + tax, 2)
